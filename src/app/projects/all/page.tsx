...
export const metadata: Metadata = {
  title: "All Projects",
  description:
    "The complete index of Melvin Darial Yogiana's work — data analyses and software builds, from ABS labour-market pipelines to award-winning hackathon projects.",
