...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  'confluence-qa': {
    ...
    sub: 'RAG assistant over team docs',
    summary:
      'A retrieval-augmented assistant that answers natural-language questions over a team’s Confluence workspace and cites the pages it drew from. Built as the UNSW software-engineering capstone (COMP3900) by a team of five working an agile cycle.',
    pull: 'An answer without a citation is just a rumour with better grammar.',
    highlights: [
      'Retrieval-augmented generation over a live Confluence workspace',
      'Every answer carries its sources, so a reader can check the claim',
      'FastAPI service behind a React front end',
      'Delivered as a COMP3900 capstone on a fixed academic deadline',
    ],
    year: '2025',
    team: '5 students',
    status: 'Capstone',
