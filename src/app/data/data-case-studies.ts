...
export const entries: DataEntry[] = [
  ...
  },
  {
    ...
    sub: 'A year of prices, two retailers',
    provenance: { label: 'Live retailer APIs, plus a backfilled year verified at 99.97%', real: true },
    figure: '7.1%',
    ...
    method: {
      source: 'Two retailer web APIs, 13 collected days, plus a backfilled year',
      transform: 'rapidfuzz pairing, dbt with SCD2 history, pre-registered buckets',
      output: 'Parity, gap, promotion and repricing, by aisle and brand tier',
    },
    shots: [],
  },
  {
