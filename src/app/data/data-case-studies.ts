...
export const entries: DataEntry[] = [
  ...
  },
  {
    ...
    figure: '7.1%',
    claim: 'parity rate in household, against 62.5% in pantry. The two chains compete where shoppers can price from memory and barely at all where they cannot.',
    blurb:
      'Competitor benchmarking on public data: prices pulled daily from both retailers web APIs, matched into identical product pairs and tracked in a dbt warehouse. Parity rate, mean absolute gap, promotion frequency and depth, and whether a price difference is a promotion or a position.',
    stack: ['Python', 'dbt', 'DuckDB', 'rapidfuzz'],
    href: '/projects/data/grocery',
    method: {
      source: 'Two retailer web APIs, 10 collected days',
      transform: 'rapidfuzz pairing, dbt with SCD2 history',
      output: 'Parity, gap and promotion measures by aisle',
    },
    shots: [],
  },
  {
