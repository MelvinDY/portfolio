...
export const grocery: CaseStudyProps = {
  ...
  blocks: [
    ...
    { t: 'p', text: 'Both claims circulate with equal confidence, and neither is usually accompanied by evidence. This study assembles the evidence.' },
    ...
    { t: 'lede', text: 'Parity rate first. On identical national-brand products the two chains rarely allow themselves to be undercut, and 43% of pairs are priced identically to the cent.' },
    {
      t: 'bars',
    ...
    { t: 'p', text: 'Averaged across the collected days, Woolworths flags 14.3% of the catalogue on promotion at any one time, against Coles’ 1.5%. The relationship inverts on depth: where a promotion is a genuine cut, the median observed discount is 41.0% at Coles against 28.6% at Woolworths. Coles promotes rarely and deeply, Woolworths often and shallowly, which is a promotional-planning difference rather than a pricing one.' },

    { t: 'lede', text: 'Reference-price integrity, and the question a single snapshot cannot reach.' },
    { t: 'p', text: 'From a single day it is possible to see that a product is flagged on promotion and what the retailer claims it previously cost. Whether the price actually fell cannot be established, because the preceding day was not observed. Across 319 promotion episodes, 186 began on a day the product had already been priced here.' },
    {
      t: 'bars',
      title: 'What the promotion flag did to the price',
      unit: '186 episodes with an observable baseline',
      bars: [
        { label: 'Price fell', value: '161', pct: 100, lead: true },
        { label: 'Price rose', value: '16', pct: 10 },
        { label: 'Price unchanged', value: '9', pct: 6 },
      ],
      read: 'Twenty-five of 186 promotions moved the price the wrong way or not at all, and all twenty-five were at Coles, whose 20 genuine cuts are outnumbered by Woolworths’ 141. The clearest case: four Schweppes mineral waters at $3.00, flagged on promotion at $3.30.',
    },
    ...
    { t: 'lede', text: 'Promotion or position. The single question the snapshot cannot answer.' },
    {
      ...
      unit: '93 episodes with a price observed on both sides',
      bars: [
        { label: 'Returned to baseline', value: '87', pct: 100, lead: true },
        { label: 'Held below baseline', value: '6', pct: 7 },
      ],
      read: 'A promotion on these shelves is deep and brief and then it is over: a median 38% off over a median run of 7 days, ending where it started. Nine in ten are a promotional cycle rather than a price change, a distinction between timing a purchase and changing where it is made.',
    },
    ...
    { t: 'p', text: 'A failed prediction of that kind is more informative than a successful one. It was wrong in a direction that named its own cause, and that cause is visible in the other measures on this page rather than invented to account for the miss.' },
