...
keywords: "my portfolio is live here is what i learned next.js shadcn ui tailwindcss web development blog system resend contact form"
---
...
I chose Next.js for its excellent developer experience and performance optimisations. The new App Router made structuring the site intuitive, and server components helped with initial load times.

### Shadcn/UI + TailwindCSS
This combination was a game-changer. Shadcn/UI provided beautiful, accessible components while TailwindCSS gave me the flexibility to customise everything exactly how I wanted it.
...
Using Next.js Image components, proper caching headers, and optimised fonts made a huge difference in load times.
